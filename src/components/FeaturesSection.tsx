...
export function FeaturesSection({ isAdmin = false }: FeaturesSectionProps) {
  const [sectionTitle, setSectionTitle] = useState("Features");
  const [features, setFeatures] = useState(defaultFeatures);

  useEffect(() => {
    const savedTitle = localStorage.getItem("featuresTitle");
  ...
  const handleTitleChange = (e: React.FormEvent<HTMLDivElement>) => {
    ...
    localStorage.setItem("featuresTitle", newTitle);
  };
